...
public class YDMessageChatReplyTableViewCell: UITableViewCell {
  ...
  // MARK: Properties
  public var currentMessage: YDChatMessage?
  var currentUserId: String = ""
  var fullMessage = ""

  // MARK: Components
  let messageLabel = UILabel()
  public let replyMessageComponent = YDReplyMessageComponent()
  ...
  public func config(
    ...
    if let repliedToChat = chat.repliedMessage {
      replyMessageComponent.configure(with: repliedToChat)
    }
  }
  ...
  func getNormalStage() -> UIColor {
    return YDColors.Gray.light
  }

  func getAmericanasStage() -> UIColor {
    return YDColors.branding
  }

  func getMyselfStage() -> UIColor {
    return YDColors.black
  }
}
